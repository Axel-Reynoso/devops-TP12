...
Aprendí DevOps desde cero en Operaciones1 usando únicamente herramientas gratuitas. Cada TP tiene un entregable concreto en GitHub que demuestra lo aprendido en práctica.
...
|---|---|---|---|
| 1 | Script de automatización del sistema | Bash, cron | [→ ver repo](https://github.com/Axel-Reynoso/devops-TP01) |
| 2 | Gestión de usuarios y permisos | Linux, chmod, useradd | [→ ver repo](https://github.com/Axel-Reynoso/devops-TP02) |
| 3 | Flujo Gitflow completo | Git, GitHub, branching | [→ ver repo](https://github.com/Axel-Reynoso/devops-TP03) |
| 4 | YAML multi-entorno + diagnóstico de red | YAML, bash, ping, dig, curl | [→ ver repo](https://github.com/Axel-Reynoso/devops-TP04) |

### Mes 2 — Contenedores y CI/CD
| TP | Proyecto | Tecnologías | Link |
|---|---|---|---|
| 5 | API Python en Docker | Docker, Flask, Gunicorn | [→ ver repo](https://github.com/Axel-Reynoso/devops-TP05) |
| 6 | App multi-contenedor | Docker Compose, Postgres, Nginx | [→ ver repo](https://github.com/Axel-Reynoso/devops-TP06) |
| 7 | Pipeline CI/CD completo | GitHub Actions, pytest, Docker Hub | [→ ver repo](https://github.com/Axel-Reynoso/devops-TP06) |
| 8 | Stack de monitoreo | Prometheus, Grafana, Node Exporter | [→ ver repo](https://github.com/Axel-Reynoso/devops-TP08) |

### Mes 3 — Kubernetes e IaC
| TP | Proyecto | Tecnologías | Link |
|---|---|---|---|
...
**Repo principal:** [devops-TP06](https://github.com/Axel-Reynoso/devops-TP06)
